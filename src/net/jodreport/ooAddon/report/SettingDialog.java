...
public class SettingDialog {
    ...
    public boolean createDialog() throws com.sun.star.uno.Exception {
        ...
        XPropertySet xFCModelMPSet = (XPropertySet) UnoRuntime.queryInterface(XPropertySet.class, dataFileModel);
        ...
        xButton.addActionListener(new SettingActionListener( this ));
    ...
    public void performOkAction(){
        XTextComponent xTextComponent = (XTextComponent) UnoRuntime.queryInterface(XTextComponent.class, getControl( _datafileName ));
